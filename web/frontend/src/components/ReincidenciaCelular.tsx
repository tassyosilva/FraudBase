...
const ReincidenciaCelular = () => {
    ...
    const { toPDF, targetRef } = usePDF({
        filename: 'relatorio-reincidencia-celular.pdf',
        format: 'a4',
        page: {
            margin: 10,
    ...
    // Função para formatar número de telefone (adiciona parênteses e hífen)
    ...
    const fetchData = async (currentPage: number) => {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/reincidencia/celular?page=${currentPage}&limit=10`, {
                headers: {
            ...
            if (!response.ok) {
                throw new Error('Erro ao buscar dados de reincidência por celular');
            }
            ...
            setError('Erro ao carregar dados de reincidência por celular');
            setData([]);
        } finally {
            setLoading(false);
        }
    ...
    const handleExportBWPDF = async () => {
        ...
        <div style="color: black; background: white; font-family: Arial, sans-serif;">
          <div style="text-align: center; margin-bottom: 20px;">
            <h1 style="color: black; font-weight: bold; margin-bottom: 10px;">RELATÓRIO DE REINCIDÊNCIA POR CELULAR</h1>
          ...
          <div style="padding: 15px; margin-bottom: 20px; border: 1px solid #999; border-radius: 4px;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
              ...
              <div>
                <p style="color: black;"><strong>Telefone:</strong> ${formatTelefone(selectedInfrator.telefone)}</p>
              </div>
          ...
          <div style="padding: 15px; border: 1px solid #999; border-radius: 4px;">
            ...
            <p style="color: black;">
              Este relatório apresenta o histórico condensado de reincidência do infrator identificado pelo número de celular. Para mais detalhes sobre cada ocorrência,
      ...
      `;
            ...
            try {
                ...
                pdf.save('relatorio-reincidencia-celular-pb.pdf');
        ...
        return (
            <Paper sx={{
                ...
                <Typography variant="h6" sx={{ color: alpha('#fff', 0.8) }}>
                    Nenhum dado de reincidência por celular encontrado.
                </Typography>
            </Paper>
        );
    }
    ...
    return (
        <Box>
            ...
            <Paper sx={{
                ...
                >
                    Reincidência de Infratores por Celular
                </Typography>
                <Typography
                    variant="subtitle1"
                    gutterBottom
                ...
                >
                    Este gráfico mostra os infratores com múltiplas ocorrências registradas no sistema, identificados pelo mesmo número de celular.
                </Typography>
            </Paper>
            ...
            <Paper sx={{
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 3, gap: 1 }}>
                    ...
                    >
                        Top Infratores Reincidentes por Celular
                    </Typography>
                </Box>
                        ...
                        <Grid item xs={12} md={6} key={index}>
                            ...
                            >
                                <CardContent>
                                    ...
                                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                                        <PhoneAndroidIcon sx={{ color: GOLD_COLOR, mr: 1 }} />
                                        <Typography variant="body1" sx={{ color: alpha('#fff', 0.9) }}>
                                            <strong>Telefone:</strong> {formatTelefone(infrator.telefone)}
                                        </Typography>
                                    </Box>
            ...
            >
                <DialogTitle sx={{
                    ...
                    <Box sx={{ fontWeight: 'bold' }}>
                        Relatório Detalhado de Reincidência por Celular
                    </Box>
                    <Box>
                        <Button
                            variant="contained"
                        ...
                        <Box ref={targetRef}>
                            ...
                            <Box sx={{ textAlign: 'center', mb: 4 }}>
                                <Typography variant="h5" sx={{ color: GOLD_COLOR, fontWeight: 'bold', mb: 1 }}>
                                    RELATÓRIO DE REINCIDÊNCIA POR CELULAR
                                </Typography>
                            ...
                            <Paper sx={{
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={12} md={6}>
                                        <Typography variant="body1" sx={{ color: alpha('#fff', 0.9) }}>
                                            <strong>Telefone:</strong> {formatTelefone(selectedInfrator.telefone)}
                                        </Typography>
                                    </Grid>
                                    <Grid item xs={12}>
                                        <Typography variant="body1" sx={{ color: alpha('#fff', 0.9) }}>
...
export default ReincidenciaCelular;