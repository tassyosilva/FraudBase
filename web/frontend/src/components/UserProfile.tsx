              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    ...
                    <Box>
                      <Typography variant="subtitle2" sx={{ color: '#aaa' }}>Cidade/Estado</Typography>
                      <Typography variant="body1" sx={{ color: 'white' }}>
                        {user?.cidade && user?.estado
                          ? `${user.cidade} - ${getEstadoNome(user.estado)}`
                          : user?.cidade || (user?.estado ? getEstadoNome(user.estado) : 'Não informado')}
                      </Typography>
                    </Box>
                  </Box>
                </Grid>
